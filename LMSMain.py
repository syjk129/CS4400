...
class Gateway:
    ...
    def switch36(self):
        ...
        gui.getfloorNumber = Entry(gui.frame2,width=18, textvariable=gui.floorNumber,state='readonly',readonlybackground='grey')
        gui.getfloorNumber.pack(side=LEFT)
        gui.getshelfNumber = Entry(gui.frame2, width=18, textvariable=gui.shelfNumber,state='readonly',readonlybackground='grey')
        ...
        gui.frame3=Frame(gui,pady=5,padx=15)
        gui.frame3.pack(expand=True,fill=BOTH)
        gui.getSubject = Entry(gui.frame3, width=18, textvariable=gui.subject,state='readonly',readonlybackground='grey')
        ...
        gui.getaisleNumber = Entry(gui.frame3, width=18, textvariable=gui.aisleNumber,state='readonly',readonlybackground='grey')
